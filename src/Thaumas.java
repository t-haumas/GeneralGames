...
public class Thaumas {

    private static double startHz = 432;
    ...
    public static double getStartHz()
    {
        return startHz;
    }

    public static void playSound(double amplitude)
    {
        playSine(startHz, 0.3, amplitude);
...
//        }
     ...
     */
        ...
        public static void main(String[] args) {
            ...
            // 440 Hz for 1 sec
            double freq = 440.0;
            for (int i = 0; i <= StdAudio.SAMPLE_RATE / 4; i++) {
